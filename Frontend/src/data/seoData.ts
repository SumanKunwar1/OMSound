...
noindex?: boolean;
nofollow?: boolean; // Added for more granular robot control
noarchive?: boolean; // Added for more granular robot control
nosnippet?: boolean; // Added for more granular robot control
noimageindex?: boolean; // Added for more granular robot control
notranslate?: boolean; // Added for more granular robot control
maxSnippet?: number; // Added for more granular robot control
maxImagePreview?: 'none' | 'standard' | 'large'; // Added for more granular robot control
maxVideoPreview?: number; // Added for more granular robot control
title: string;
description: string;
keywords: string | string[]; // Changed to allow array or string
image?: string;
type?: string;
...
home: {
  ...
  structuredData: {
    ...
    "logo": "https://omsounds.com/logo.png",
    "contactPoint": {
      "@type": "ContactPoint",
    ...
    "sameAs": [
      "https://facebook.com/omsounds",
      "https://instagram.com/omsounds",
      "https://youtube.com/omsounds"
    ]
  },
  noindex: false,
  twitterSite: "@omsounds",
  twitterCreator: "@omsounds",
},
shop: {
